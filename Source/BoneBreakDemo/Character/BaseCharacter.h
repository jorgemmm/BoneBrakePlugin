...
UCLASS()
class BONEBREAKDEMO_API ABaseCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "ExploteBone")//, meta = (AllowPrivateAccess = "true"))
